                        ...
                        <form method="post" action="EmpleadoControl" >
                            <div class="container">
                                <div class="row">
                                    <div class="col-12 px-0">
                                        <div class="form-group">
                                            ...
                                            <input placeholder="E001" id="cod" name="cod" type="text" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-12 px-0">
                                        <div class="form-group">
                                            <label clas="formGroupExampleInput" for="tip">Tipo</label>
                                            <input id="tip" name="tip" type="text" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
